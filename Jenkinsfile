...
def upstreamProjects = [
  ...
  '../resources/filesystem', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-resources-filesystem</artifactId>
  '../resources/union', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-resources-union</artifactId>
